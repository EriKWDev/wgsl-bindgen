...
use crate::{WgslBindgenOption, WgslMatType, WgslType, WgslTypeAlignmentAndSize, WgslVecType};
...
pub(crate) fn custom_vector_matrix_assertions(options: &WgslBindgenOption) -> TokenStream {
    fn build_assert_for(
...
fn map_naga_vec_type(
    ...
    let expected_size_after_alignment = alignment.round_up(size as u32 * scalar.width as u32);
